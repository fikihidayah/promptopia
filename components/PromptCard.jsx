...
// 03:10:00
function PromptCard({post, handleTagClick, handleEdit, handleDelete, handleUserClick}) {
    ...
    <div className='prompt_card'>
      <div className='flex justify-between items-start gap-5'>
        <div className='flex-1 flex justify-start items-center gap-3 cursor-pointer'>
          ...
          <div className='flex flex-col' onClick={() => handleUserClick && handleUserClick(post.creator)}>
      ...
      <p className='text-sm text-gray-800 font-satoshi my-4'>{post.prompt}</p>
      <p className='text-sm blue_gradient cursor-pointer font-inter'
